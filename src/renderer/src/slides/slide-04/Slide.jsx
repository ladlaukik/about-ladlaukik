  ...
  return (
    <div className="equation-slide">
      ...
      <div className="equation" ref={equationRef}>
        ...
        />
        <span className="equation-operator">=</span>
        {/* PRODUCT is filled now, so DESIGN reads against that fill (var(--bg))
            instead of the usual dimmed treatment, which would nearly vanish
            against a same-hue solid background. */}
        <span className="equation-word equation-word-design equation-word-on-fill" ref={designRef}>
          DESIGN
        </span>
        ...
        <svg className="equation-box-svg" aria-hidden="true">
          ...
          {productBox && (
            <rect
              ...
              rx={productBox.rx}
              ry={productBox.rx}
              className="equation-box-rect equation-box-rect-filled"
              style={{
        ...
        {productBox && (
          <span
            className="equation-box-label equation-box-label-accent"
            style={{
